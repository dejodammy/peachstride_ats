...
export default function ApplyPage() {
  ...
  const validateStep = () => {
    ...
    if (step === 1) {
      ...
      else if (!/^\+?[\d\s-()]{10,}$/.test(form.phone)) newErrors.phone = "Invalid phone format";
    } else if (step === 2) {
      if (!form.gender) newErrors.gender = "Please select a gender";
      if (!form.age.trim()) newErrors.age = "Age is required";
      else if (parseInt(form.age) < 18 || parseInt(form.age) > 65) newErrors.age = "Age must be between 18-65";
  ...
  const prevStep = () => { setStep(1); setErrors({}); };
  ...
  const onSubmit = async () => {
    ...
    try {
      ...
      if (nysc) formData.append("nysc", nysc);

      const res = await fetch("/api/applicants", { method: "POST", body: formData });
      if (!res.ok) throw new Error("Failed to submit application");

      const data = await res.json();
      if (!data.ok) throw new Error(data.error || "Unknown server error");

      // ✅ Correct: use applicantId from API response
      router.push(`/test?applicantId=${data.applicantId}`);
    } catch (err: any) {
    ...
    <div className="min-h-screen" style={{
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen p-4 sm:p-6">
        <div className="w-full max-w-4xl">
          ...
          {/* Progress Bar */}
          <div className="mb-8">
            <div className="flex items-center justify-between text-sm mb-2" style={{ color: '#848688' }}>
              <span className={step >= 1 ? "font-medium" : ""} style={{ color: step >= 1 ? '#ed3237' : '#848688' }}>
                Personal Info
              </span>
              <span className={step >= 2 ? "font-medium" : ""} style={{ color: step >= 2 ? '#ed3237' : '#848688' }}>
                Details & Documents
              </span>
            </div>
          ...
          <div className="bg-white/95 backdrop-blur-sm shadow-2xl rounded-3xl p-8 border border-white/30">
            <div className="space-y-6">
              {step === 1 && (
                <div className="space-y-6">
                  <h2 className="text-2xl font-semibold mb-6 flex items-center" style={{ color: '#373435' }}>
                    <span className="w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold mr-3"
                          style={{ backgroundColor: '#ed3237', color: 'white' }}>1</span>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="group">
                      ...
                      <input
                        ...
                        onBlur={(e) => e.target.style.borderColor = errors.firstName ? '#ed3237' : '#e5e7eb'}
                      />
                      {errors.firstName && <p className="text-sm mt-1" style={{ color: '#ed3237' }}>{errors.firstName}</p>}
                    </div>
                    <div className="group">
                      <label className="block text-sm font-medium mb-2" style={{ color: '#373435' }}>
                        Last Name *
                      ...
                      <input
                        ...
                        onFocus={(e) => e.target.style.borderColor = '#ed3237'}
                        onBlur={(e) => e.target.style.borderColor = errors.lastName ? '#ed3237' : '#e5e7eb'}
                      />
                      {errors.lastName && <p className="text-sm mt-1" style={{ color: '#ed3237' }}>{errors.lastName}</p>}
                    </div>
                  </div>
                  ...
                  <div className="space-y-6">
                    <div className="group">
                      ...
                      <input
                        ...
                        onFocus={(e) => e.target.style.borderColor = '#ed3237'}
                        onBlur={(e) => e.target.style.borderColor = errors.email ? '#ed3237' : '#e5e7eb'}
                      />
                      {errors.email && <p className="text-sm mt-1" style={{ color: '#ed3237' }}>{errors.email}</p>}
                    </div>
                    ...
                    <div className="group">
                      ...
                      <input
                        ...
                        onFocus={(e) => e.target.style.borderColor = '#ed3237'}
                        onBlur={(e) => e.target.style.borderColor = errors.phone ? '#ed3237' : '#e5e7eb'}
                      />
                      {errors.phone && <p className="text-sm mt-1" style={{ color: '#ed3237' }}>{errors.phone}</p>}
                    </div>
                  </div>
              ...
              {step === 2 && (
                <div className="space-y-6">
                  <div className="flex items-center justify-between">
                    <h2 className="text-2xl font-semibold flex items-center" style={{ color: '#373435' }}>
                      <span className="w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold mr-3"
                            style={{ backgroundColor: '#ed3237', color: 'white' }}>2</span>
                      Additional Details
                    </h2>
                    <button
                      type="button"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="group">
                      ...
                      <select
                        ...
                        onFocus={(e) => e.target.style.borderColor = '#ed3237'}
                        onBlur={(e) => e.target.style.borderColor = errors.gender ? '#ed3237' : '#e5e7eb'}
                      >
                        <option value="">Select gender</option>
                        <option value="male">Male</option>
                        <option value="female">Female</option>
                      </select>
                      {errors.gender && <p className="text-sm mt-1" style={{ color: '#ed3237' }}>{errors.gender}</p>}
                    </div>
                    ...
                    <div className="group">
                      ...
                      <input
                        ...
                        onFocus={(e) => e.target.style.borderColor = '#ed3237'}
                        onBlur={(e) => e.target.style.borderColor = errors.age ? '#ed3237' : '#e5e7eb'}
                      />
                      {errors.age && <p className="text-sm mt-1" style={{ color: '#ed3237' }}>{errors.age}</p>}
                    </div>
                  </div>
                  ...
                  <div className="space-y-6">
                    <div className="group">
                      ...
                      <select
                        ...
                        onFocus={(e) => e.target.style.borderColor = '#ed3237'}
                        onBlur={(e) => e.target.style.borderColor = errors.state ? '#ed3237' : '#e5e7eb'}
                      >
                      ...
                      {errors.state && <p className="text-sm mt-1" style={{ color: '#ed3237' }}>{errors.state}</p>}
                    </div>
                    ...
                    <div className="group">
                      ...
                      <textarea
                        ...
                        onFocus={(e) => e.target.style.borderColor = '#ed3237'}
                        onBlur={(e) => e.target.style.borderColor = errors.address ? '#ed3237' : '#e5e7eb'}
                      />
                      {errors.address && <p className="text-sm mt-1" style={{ color: '#ed3237' }}>{errors.address}</p>}
                    </div>
                  </div>
                  ...
                  <div className="space-y-6">
                    <div className="group">
                      ...
                      <div className="border-2 border-dashed rounded-xl p-6 text-center hover:border-opacity-60 transition-colors"
                        ...
                        <label htmlFor="cv-upload" className="cursor-pointer block">
                          ...
                          <p className="text-sm" style={{ color: '#848688' }}>
                            {cv ? cv.name : "Click to upload CV (PDF, DOC, DOCX)"}
                          </p>
                        </label>
                      </div>
                    </div>
                    ...
                    <div className="group">
                      ...
                      <div className="border-2 border-dashed rounded-xl p-6 text-center hover:border-opacity-60 transition-colors"
                        ...
                        <input
                          ...
                          id="nysc-upload"
                        />
                        <label htmlFor="nysc-upload" className="cursor-pointer block">
                          <div className="mb-2" style={{ color: '#848688' }}>
                            <svg className="mx-auto w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
                            </svg>
                          ...
                          <p className="text-sm" style={{ color: '#848688' }}>
                            {nysc ? nysc.name : "Click to upload NYSC Certificate"}
                          </p>
                        </label>
                      </div>
                    </div>
              ...
              {msg && (
                <div className={`rounded-xl p-4 text-center font-medium transition-all duration-300 border ${
                  msg.startsWith("✅")
                ...
                style={msg.startsWith("❌") ? { backgroundColor: '#ed3237' } : {}}>
                  {msg}
                </div>
              )}
            </div>
          ...
          <div className="text-center mt-8 text-sm" style={{ color: '#848688' }}>
            <p>Need help? Contact us on <span style={{ color: '#ed3237' }}>info@peachstridesandoristine.com</span></p>
          </div>
        </div>
      </div>
    </div>
